...
class Provinces(BaseModel):
    ...
    province_id: Optional[str] = Field(default=None, description='Province code from source (varchar 80)')
...
class Districts(BaseModel):
    ...
    id: str = Field(description='Primary key (text id)')
    province_id: Optional[str] = Field(default=None, description='Province code (varchar 80)')
    district_id: Optional[str] = Field(default=None, description='District code from source (varchar 80)')
    ...
    num_id: Optional[int] = Field(default=None, description='Numeric id from GIS source')
    extent_minx: Optional[float] = Field(default=None, description='Bounding box min longitude')
    extent_maxx: Optional[float] = Field(default=None, description='Bounding box max longitude')
    extent_miny: Optional[float] = Field(default=None, description='Bounding box min latitude')
    extent_maxy: Optional[float] = Field(default=None, description='Bounding box max latitude')
...
class DistricStats(BaseModel):
    ...
    num_id: Optional[int] = Field(default=None, description='Numeric district identifier')
    val_sum: Optional[float] = Field(default=None, description='Sum of measured values (double)')
    num: Optional[int] = Field(default=None, description='Count used in aggregation')
    val_avg: Optional[float] = Field(default=None, description='Average value (double)')
